...
![Incremental RemNote Logo](https://raw.githubusercontent.com/bjsi/incremental-everything/main/img/inc-logo-2.jpeg)
...
👉 [Full documentation](https://hugomarins.github.io/incremental-remnote/History-Queue-Dashboard-and-Mastery-Drill/)
...
Beyond the core learning loop, Incremental RemNote ships **dozens of standalone utilities** that make day-to-day note-taking and knowledge-base organization faster — useful even when you're not reviewing. A few examples:

- **Outline & heading tools**: [Restructure Outline by Headings](https://hugomarins.github.io/incremental-remnote/Utilities-Outline-and-Headings/#restructure-outline-by-headings) (re-nest a flat or mis-pasted document under its headings), [Apply Heading Levels by Hierarchy (Table of Contents)](https://hugomarins.github.io/incremental-remnote/Utilities-Outline-and-Headings/#apply-heading-levels-by-hierarchy-table-of-contents), and [Set Next Heading Level](https://hugomarins.github.io/incremental-remnote/Utilities-Outline-and-Headings/#set-next-heading-level) — all with side-by-side previews and one-click undo.
- **Queue display control**: [Hide / Remove Parent & Grandparent and more](https://hugomarins.github.io/incremental-remnote/Utilities-Queue-Display/) to clean up how ancestor Rems appear on your flashcards.
- **Editing helpers**: [Text Case Converter](https://hugomarins.github.io/incremental-remnote/Utilities-Text-and-Lists/#text-case-converter) (Shift+F3 cycling, with English/Portuguese title-case rules) and [Bulletize Inline Selected Text](https://hugomarins.github.io/incremental-remnote/Utilities-Text-and-Lists/#bulletize-inline-selected-text) for restoring bullets that PDF highlights flatten.
- **Navigation & sources**: [Find Rem](https://hugomarins.github.io/incremental-remnote/Utilities-Finding-and-Navigating/#find-rem-reference-or-open) (surfaces Rems RemNote's `[[` search can't) and [Open Source in Popup / Floating Window](https://hugomarins.github.io/incremental-remnote/Utilities-Finding-and-Navigating/#open-source-in-popup) to peek at a PDF/web source without leaving the queue.
- **Analytics & diagnostics**: the [Study Dashboard](https://hugomarins.github.io/incremental-remnote/Study-Dashboard/) for KB-wide learning stats and the [History suite & Practiced Queues Dashboard](https://hugomarins.github.io/incremental-remnote/History-Queue-Dashboard-and-Mastery-Drill/) to revisit any document, flashcard, or past session.
- **Per-item review insight**: drill into a single item's timeline with the [Flashcard Repetition History](https://hugomarins.github.io/incremental-remnote/Plugin-Widgets-Reference/#211-flashcard-repetition-history) and [IncRem Repetition History](https://hugomarins.github.io/incremental-remnote/Plugin-Widgets-Reference/#212-increm-repetition-history--aggregated-view) popups — the latter with an **aggregated roll-up** of reps, time, and counts across a Rem's whole descendant subtree. Backed by an embedded **FSRS v6** engine that computes per-card Difficulty / Stability / Retrievability, plus a clickable [priority-weighted Shield breakdown](https://hugomarins.github.io/incremental-remnote/Prioritization-&-Sorting/#weighted-shield) of how much of your workload you've processed.

👉 See the **[Utilities](https://hugomarins.github.io/incremental-remnote/Utilities/)** page for the full list, and the **[Plugin Commands Reference](https://hugomarins.github.io/incremental-remnote/Plugin-Commands-Reference/)** for every command.

### 🔌 Integrations

- **Logos Bible Software** *(macOS)*: Read your Logos books incrementally — import books, extract passages and keep bookmarks with shortcuts pressed in Logos. [Learn more](https://hugomarins.github.io/incremental-remnote/Logos-Bible-Software-Integration/)

## Installation

- Open the [RemNote plugin store](https://www.remnote.com/plugins), search for "Incremental RemNote" and install the plugin.

## 📚 Documentation & Support

This README covers the basics. For the comprehensive guides, please visit the **User's Manual**:

👉 **[Incremental RemNote — User's Manual](https://hugomarins.github.io/incremental-remnote/)**
...
### Useful Links
- **[Changelog](https://hugomarins.github.io/incremental-remnote/Changelog/)**: See the latest features and updates.
...
![Incremental Video](https://hugomarins.github.io/incremental-remnote/assets/YT-extract-mode.png)
...
- The Lean plugin provides the queue widget and the Incremental RemNote plugin provides the scheduling.
